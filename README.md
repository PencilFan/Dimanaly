...
## 说明与改进
* **关于数据库**
&emsp;&emsp;为方便获取物理量的量纲信息,此程序使用了一个excel文件,当然用户可以根据自己的需求在原程序的基础上稍加修改使用csv文件或SQL数据库等.
&emsp;&emsp;它的好处在于用户可以根据自己的需求与偏好设置所需物理量的符号、量纲、数值,但坏处是对于没有相关数据资源的用户,他们就难以体验到使用数据库信息所带来的便捷,虽然data_base.xlsx文件中也提供了一些数据信息,但并不全面.
